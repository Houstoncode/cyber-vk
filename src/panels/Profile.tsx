    ...
    <Panel id={id} >
      ...
      <Group>
        <div className="statistic" style={{
          ...
          <div className="statistic__left" style={{
            height: '93px',
            width: '93px',
          ...
          <div className="statistic__right"><img src="images/analiz.png" alt="" /></div>
        </div>
        <div style={{
          textAlign: 'center',
          margin: '20px'
          ...
          <Link href="#" style={{
            fontSize: "17px",
            lineHeight: '22px',
          }}>Расширенная статистика</Link>
        </div>
        <Card className="characteristic" style={{
          padding: '12px 16px',
          minHeight: '87px',
          borderRadius: '14px',
          width: '96%',
          ...
          <Title level="3" weight="regular" style={{
            fontSize: '13px',
            lineHeight: '24px',
            ...
            color: '#3F8AE0',
            fontSize: '10px',
          }} />Характеристика игрока</Title>
          <Title level="3" weight="regular" style={{
            color: '#fff',
            fontSize: '16px',
            lineHeight: '20px',
          }}>Игрок с хорошей репутацией.</Title>
        </Card>
        <Title level="3" weight="regular" style={{
          color: 'black',
          fontSize: '24px',
